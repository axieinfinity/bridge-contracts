...
// IsPeriodPendingPrivate is a free data retrieval call binding the contract method 0x9b8c334b.
//
// Solidity: function _isPeriodEnding(uint256 _newPeriod) view returns(bool)
func (_Validator *ValidatorCaller) IsPeriodPendingPrivate(opts *bind.CallOpts, _newPeriod *big.Int) (bool, error) {
	var out []interface{}
...
//
// Solidity: function _isPeriodEnding(uint256 _newPeriod) view returns(bool)
func (_Validator *ValidatorSession) IsPeriodPendingPrivate(_newPeriod *big.Int) (bool, error) {
	return _Validator.Contract.IsPeriodPendingPrivate(&_Validator.CallOpts, _newPeriod)
}

// IsPeriodPendingPrivate is a free data retrieval call binding the contract method 0x9b8c334b.
//
// Solidity: function _isPeriodEnding(uint256 _newPeriod) view returns(bool)
func (_Validator *ValidatorCallerSession) IsPeriodPendingPrivate(_newPeriod *big.Int) (bool, error) {
	return _Validator.Contract.IsPeriodPendingPrivate(&_Validator.CallOpts, _newPeriod)
}
...
// Initialize is a paid mutator transaction binding the contract method 0x002f5fd7.
//
